...
public class AlmacenModel extends RecursiveTreeObject<AlmacenModel> {
    ...
    public AlmacenModel(int anInt, int resultadoInt, String string, String resultadoString, int i, int anInt1, String s, double aDouble, int resultadoInt1, double resultadoDouble) {
    ...
    public void llenarInformacionOrdenes(ObservableList<AlmacenModel> listas){
