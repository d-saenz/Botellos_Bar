 ...
 * @author Your Name
 */
public class FXMLAlmacenController implements Initializable {

    OrdenesModel oM = new OrdenesModel();

    @FXML
    private JFXTreeTableView<OrdenesModel> table;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        table.getColumns().setAll(detalle_id,orden_id,fecha,producto,cantidad,capacidad,medicion,precio_unitario,mesa,total);
        table.setRoot(roots);
